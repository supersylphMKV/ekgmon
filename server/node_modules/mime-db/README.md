...
- http://server.iana.org/assignments/media-types/media-types.xhtml
...
- `.source` - where the mime type is defined.
    ...
    - `iana` - [IANA-defined media types](http://server.iana.org/assignments/media-types/media-types.xhtml)
