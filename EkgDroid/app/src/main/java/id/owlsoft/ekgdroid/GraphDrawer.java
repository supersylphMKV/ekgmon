...
public class GraphDrawer extends View{
    ...
    public  void InputData(byte[] data){
        byte[] c = (byte[]) Array.newInstance(reservedVal.getClass().getComponentType(), reservedVal.length + data.length);
    ...
    public void onDraw(Canvas canvas) {
        if(isDrawing){
            Log.i("val",String.valueOf(currentDotTgt));
            DrawGraph(canvas);
        }
        invalidate();
    }
